...
const uint8_t Speaker_ConfigDescriptor[] =
  {
    ...
    0x64,                                 /* wTotalLength  110 bytes*/ // AMM
    0x00,
    0x02,                                 /* bNumInterfaces */
...
//    0x01,                                 /* wFormatTag AUDIO_FORMAT_PCM8  0x0002*/     // AMM
    ...
    0x01,                                 /* bNrChannels */
    0x02,                                 /* bSubFrameSize */ // AMM
    0x10,                                    /* bBitResolution */ // AMM
    0x01,                                 /* bSamFreqType */
    0x40,                                 /* tSamFreq 22000 = 0x55F0 */ // AMM
    0x1F,
    0x00,
    /* 11 byte*/
...
const uint8_t Speaker_StringProduct[0x14] = // AMM
  {
