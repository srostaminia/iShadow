...
#define _CPAL_TIMEOUT_INIT()            NVIC_SetPriority (SysTick_IRQn, 0) 
...
//#define CPAL_I2C_TIMEOUT_Manager       SystTick_Handler         /*<! This callback is used to handle Timeout error.
