    ...
    for j=1:length(uniFolderList)
        ...
        for k=1:nLambda
            ...
            for m=1:nRep
                ...
                %repdir= fullfile(rootDir,strcat('awesomeness_irb_',object),strcat(subName,'_',lighting),uni,'results',lambdaFolder,strcat(modelName,'_rep','_outdoor_test_Feb13',num2str(m),'.mat'));
