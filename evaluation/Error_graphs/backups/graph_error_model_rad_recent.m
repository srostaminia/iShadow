...
function [errStEachSub,uniFolderList,stdErrAllSub,meanErr_line_ForAllSub,stdErr_line_ForAllSub]=graph_error_model_rad(lighting,modelName,subList,rootDir,object,objForTitle,ylabelunit,dataObj,title)
    ...
    for j=1:length(uniFolderList)
        ...
        for k=1:nLambda
            ...
            for m=1:nRep
                ...
                repdir= fullfile('/Users/ytun/iShadow/algorithms/cider/data/awesomeness_irb_pupil_mixed/addison_outmodeLong_and_benchmark/uniquefy_0/results',lambdaFolder,strcat('ann_mixed','rep',num2str(m),'.mat'));
