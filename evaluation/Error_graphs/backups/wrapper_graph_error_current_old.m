...
folderName='awesomeness_parallel_test';
...
for indFile=2
    ...
    [annErrStEachSub,annMeanErrorAllSub,annStdErrorAllSub,annIndPerAllSub]=graph_error_model_current(indFile,linestyle,modelName,subList,rootDir,lightingSubFolder,objToPlot);
    
    % CHANGE HERE:
    modelName='cider'; % 'ANN' %'both'
    [ciderErrStEachSub,ciderMeanErrorAllSub,ciderStdErrorAllSub,ciderIndPerAllSub,lineMeanErrorAllSub,lineStdErrorAllSub,meanAnnUsedForAllSub,stdAnnUsedForAllSub,meanLineUsedForAllSub,stdLineUsedForAllSub]=graph_error_model_current(indFile,linestyle,modelName,subList,rootDir,lightingSubFolder,objToPlot);
    
end
legend({'ann-5 percentile','cider-5 percentile','line-5 percentile','ann-0.05 percentile','cider-0.05 percentile','line-0.05 percentile','ann-2 percentile','cider-2 percentile','line-2 percentile','ann-mean','cider-mean','line-mean'});
