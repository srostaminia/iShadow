...
function graph_error_model_current_meanOfmean_saveAllData(s,indFile,linestyle,modelName,subList,rootDir,lightingSubFolder,objToPlot,subModelName,compareLine)
...
for i=1:nUsers
    ...
    for k=1:nLambda
        ...
        for m=1:nRep
            ...
            elseif strcmp(objToPlot,'pupilLoc-pixel')
...
save(fullfile(dir,strcat(objToPlot,'Err_',modelName,'_',subModelName,'_',s,'.mat')),'meanErrMatForAllSub');%,%'lineUsed_Lambdas_mean');
