...
dir='/Users/ytun/Google Drive/IMPORTANT_VISION/Data_Err/calib';
...
load(fullfile(dir,'..','table_power_old.mat'));
...
for i=1:2
    ...
    if savePlotOn
        plotFileName=strcat(fileNameList{i},'metricsGraphs');
    else
        plotFileName='';
    end
