...
CONTRAST_ADJUST = 0
TX_BITS = 8
PARAM_PACKET_SIZE = 3 #instead of 10
plt.ion()
def main():
    ...
    fig = plt.figure(999)
    image=plt.imshow(np.zeros((4,112)), cmap = matplotlib.cm.Greys_r, interpolation='nearest')
    ...
    while True:
        ...
        while not rx_complete:
            ...
            # Read 10 packets of data = 1840
            data = endp.read(184 * 3)
            ...
            if TX_BITS == 16:
                ...
                unpacked = struct.unpack('B' * (184 * 3), data)
