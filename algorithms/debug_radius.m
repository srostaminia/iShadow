...
%subDir='data/awesomeness_pupil_1sm4_uniquefy/yamin_1sm4_pupil/full/results/subset_l1_init_strips_k7_lambda0.000464';%'awesomeness_pupil_1sm4_uniquefy/yamin_1sm4_pupil/full/results/subset_l1_init_strips_k7_lambda0.000100';
subDir='data/awesomeness_irb_pupil/akshaya_calib_pupil/uniquefy_0/results/subset_l1_init_strips_k7_lambda0.000215';%'awesomeness_pupil_1sm4_uniquefy/yamin_1sm4_pupil/full/results/subset_l1_init_strips_k7_lambda0.000100';
...
colorbar;
title('Training Error at Predicted Pupil Center');
...
imagesc(errMat_test);
colorbar;
title('Test Error at Predicted Pupil Center');
...
imagesc(errMat_train);
colorbar;
title('Training Error at True Pupil Center');
...
imagesc(errMat_test);
colorbar;
title('Test Error at True Pupil Center');

suptitle('Akshaya: Error Heat Map');
