...
clear;
labeldir='/Users/ytun/Google Drive/Vision/MobiSys2015_labeling/label';
labelPupildir='/Users/ytun/Google Drive/Vision/MobiSys2015_labeling/labelPupil';
...
for z=1:length(names)
    ...
    for y=1:length(lightings)
        ...
        filename=strcat(name,'_',lighting,'_pupil_v7.mat');
